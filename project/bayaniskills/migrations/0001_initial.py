# Generated by Django 6.0.1 on 2026-04-10 13:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('client', 'Client'), ('bayani', 'Bayani')], default='client', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bayani', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bayani_bookings', to=settings.AUTH_USER_MODEL)),
                ...
                ('skill', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bayaniskills.skill')),
            ],
        ),
    ]
